...
export const symbolData = {
  ...
  jzwPointSymbol: new AMap.Icon({
    ...
    size: new AMap.Size(28, 33),
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_point_jzw.png', import.meta.url).href,
    // 图标所用图片大小
    imageSize: new AMap.Size(28, 33),
    // 图标取图偏移量
    imageOffset: new AMap.Pixel(0, 0)
  ...
  wgyPointSymbol: new AMap.Icon({
    ...
    size: new AMap.Size(28, 33),
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_point_wgy.png', import.meta.url).href,
    // 图标所用图片大小
    imageSize: new AMap.Size(28, 33),
    // 图标取图偏移量
    imageOffset: new AMap.Pixel(0, 0)
  ...
  sjzsPointSymbol: new AMap.Icon({
    ...
    size: new AMap.Size(28, 33),
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_point_sjzs.png', import.meta.url).href,
    // 图标所用图片大小
    imageSize: new AMap.Size(28, 33),
    // 图标取图偏移量
    imageOffset: new AMap.Pixel(0, 0)
  ...
  ryzsPointSymbol: new AMap.Icon({
    ...
    size: new AMap.Size(28, 33),
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_point_ryzs.png', import.meta.url).href,
    // 图标所用图片大小
    imageSize: new AMap.Size(28, 33),
    // 图标取图偏移量
    imageOffset: new AMap.Pixel(0, 0)
  ...
  ynsjPointSymbol: new AMap.Icon({
    ...
    size: new AMap.Size(28, 33),
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_point_ynsj.png', import.meta.url).href,
    // 图标所用图片大小
    imageSize: new AMap.Size(28, 33),
    // 图标取图偏移量
    imageOffset: new AMap.Pixel(0, 0)
  ...
  zdqyPointSymbol: new AMap.Icon({
    ...
    size: new AMap.Size(28, 33),
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_point_zdqy.png', import.meta.url).href,
    // 图标所用图片大小
    imageSize: new AMap.Size(28, 33),
    // 图标取图偏移量
    imageOffset: new AMap.Pixel(0, 0)
  ...
  dotPicturePointSymbol: new AMap.Icon({
    ...
    // 图标的取图地址
    image: new URL('@/assets/img/grid/icon_dot_green.png', import.meta.url).href,
    // 图标所用图片大小
...
export const useCreateMarker = (
  ...
  if (infoWindowContent) {
    marker.on('click', () => {
      ...
      useChangePointIcon(map, data, layGroups, 'dotPicturePointSymbol', 'dotPictureActivePointSymbol')
    })
  }
 ...
 */
export const useChangePointIcon = (map: any, row: any, layer: any, symbol: string, activeSymbol: string) => {
