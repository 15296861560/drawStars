export default {
  footer: {
    msg: '2020· DrawStars · Server sponsorship: Unpublished '
  },
  homePage: {
    echart: 'Echart',
    tool: 'Tool',
    ...
    echartHomePage: {
      ...
      basicArea: 'Basic Area map',
      basicPie: 'Basic Pie',
      baiduMap: 'Baidu Maps',
      bar: 'Histogram',
      stackedBar: 'Stacked column chart',
      barLineDrill: 'Mixed column diagram',
  ...
  layoutSettings: {
    navTitle: 'Navigation layout',
    navLeft: 'Left sidebar',
    navMix: 'Compact sidebar',
    navTop: 'Top menu',
    ...
    dynamicTitle: 'Dynamic document title',
    footer: 'Footer',
    save: 'Save',
    reset: 'Reset',
  ...
  tips: {
    ...
    addImgSuccess:
      'After the picture is successfully added, the editing function starts automatically',
    comfirmDownloadImg: 'Are you sure you want to download the picture?',
    downloadSuccess: 'Download successful!',
    cancelDownload: 'Download canceled!',
    confirmUpload:
      'Re uploading will clear all the edited content. Do you want to continue uploading?',
  ...
  module: {
    echarts: {
      baiduMap: {
        ...
        longitude: 'Longitude:',
        latitude: 'Latitude:',
        showSearchList: 'Show search list',
  ...
  btn: {
    ...
    previewAnimate: 'Preview animation',
    addEvent: 'Add event',
    confirm: 'Confirm',
    undo: 'Undo',
    redo: 'Redo',
    insertImg: 'Insert picture',
    preview: 'Preview',
    save: 'Save',
    clearCanvas: 'Empty canvas',
    compose: 'Compose',
    decompose: 'Decompose',
    property: 'Property',
    animation: 'Animation',
