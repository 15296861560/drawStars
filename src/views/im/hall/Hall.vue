    ...
    <el-scrollbar class="im-hall-scroll">
      ...
      >
        <template #tag>
          ...
          <el-tag v-if="r.onlineCount" size="small" type="success"
            >{{ r.onlineCount }}在线</el-tag
          >
        </template>
        <template #sub>
          <div class="im-hall-tags">
            <span v-for="t in r.tags" :key="t" class="im-hall-tag"
              >#{{ t }}</span
            >
      ...
      <el-empty
        v-if="!hallList.length && !hallLoading"
        description="暂无房间"
        :image-size="60"
      />
    </el-scrollbar>
    ...
    <el-dialog v-model="createDialog" title="创建房间" width="420px">
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="公告"
          ><el-input v-model="createForm.notice" type="textarea"
        /></el-form-item>
        ...
        <el-form-item label="匿名发言"
          ><el-switch v-model="createForm.anonymousSpeak"
        /></el-form-item>
      </el-form>
      <template #footer>
