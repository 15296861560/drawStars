    ...
    <div class="g-list-vertical">
      ...
      <div class="translate-part">
        <div class="original-lang">
          ...
          <i class="el-icon-circle-close clear-org" title="清空"></i>
        </div>
...
<script>
import storage from "@/utils/commom/storage.js";
...
export default {
  ...
  methods: {
    async translate() {
      ...
      // 获取appid和签名
      await this.$axios({ contents, salt }, "/translateApi/getSign").then((res) => {
        if (res.status) {
