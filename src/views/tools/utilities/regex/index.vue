        ...
        <div class="m-content-area">
          ...
          <div class="m-example-area">
            ...
            <div class="m-example-result">
              ...
              <br />
              <div class="m-refresh">
                <i class="el-icon-refresh" @click="regex(1)"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="m-content-area">
          ...
          <div class="m-example-area">
            ...
            <div class="m-example-result">
              ...
              <br />
              <div class="m-refresh">
                <i class="el-icon-refresh" @click="regex(2)"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="m-content-area">
          ...
          <div class="m-example-area">
            ...
            <div class="m-example-result">
              ...
              <br />
              <div class="m-refresh">
                <i class="el-icon-refresh" @click="regex(3)"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="m-content-area">
          ...
          <div class="m-example-area">
            ...
            <div class="m-example-result">
              ...
              <br />
              <div class="m-refresh">
                <i class="el-icon-refresh" @click="regex(4)"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="m-content-area">
          ...
          <div class="m-example-area">
            ...
            <div class="m-example-result">
              ...
              <br />
              <div class="m-refresh">
                <i class="el-icon-refresh" @click="exampleRegExp"></i>
              </div>
            </div>
...
export default {
  ...
  methods: {
    regex(key) {
      switch (key) {
        case 1:
          let regex = /^[a-zA-Z]+$/; // 直接量正则表达式
          this.regexResult1 = regex.test(this.regexInput1);
          break;
        case 2:
          var regex = new RegExp("^[a-zA-Z]+$"); // 构造函数
          this.regexResult2 = regex.test(this.regexInput2);
          break;
        case 3:
