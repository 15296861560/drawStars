...
const def: QuestionTypeDef = {
  ...
  icon: 'Grid',
  category: 'advanced',
  defaultConfig: () => ({ rows: [{ id: 'r1', label: '行1' }, { id: 'r2', label: '行2' }], columns: [{ id: 'c1', label: '列1' }, { id: 'c2', label: '列2' }] }),
  createQuestion(partial) {
    return createBaseQuestion('matrix_radio', '矩阵单选', this.defaultConfig, partial)
  },
