...
const appApi = {
   ...
   */
  updateApp: (data) => requests({ url: `/api/appApi/update`, data, method: 'put' }),
   ...
   */
  deleteApp: (id) => requests({ url: `/api/appApi/delete/${id}`, method: 'delete' }),
   ...
   */
  batchDeleteApp: (ids) => requests({ url: `/api/appApi/batchDelete`, data: ids, method: 'delete' }),
   ...
   */
  publishApp: (id) => requests({ url: `/api/appApi/publish/${id}`, method: 'post' })
};
