      ...
      <el-col>
        ...
        >
          ...
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-1" @click="toEcharts"><i class="el-icon-s-data"></i>图表</el-menu-item>
          ...
          <el-submenu index="3">
            ...
            <el-menu-item-group>
              <el-menu-item index="3-1" @click="levelDown"><i class="el-icon-caret-bottom"></i>降低权限</el-menu-item>
              <el-menu-item index="3-2" @click="levelUp"><i class="el-icon-caret-top"></i>提高权限</el-menu-item>
              <el-menu-item index="3-3"><i class="el-icon-d-caret"></i>当前权限等级{{ userData.level }}</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
      </el-col>
